...
public class HashTableOpenAddressingLinearProbing<K, V> implements Iterable<K> {
	...
	public HashTableOpenAddressingLinearProbing() {
		this(DEFAULT_CAPACITY, DEFAULT_LOAD_FACTOR);
	}
	
	public HashTableOpenAddressingLinearProbing(int capacity) {
		this(capacity, DEFAULT_LOAD_FACTOR);
	}
	
	public HashTableOpenAddressingLinearProbing(int capacity, double loadFactor) {
	...
	public static void main(String[] args) {
		...
		HashTableOpenAddressingLinearProbing<String, String> qp = new HashTableOpenAddressingLinearProbing<>();
		qp.add("1", "apple");
		qp.add("2", "iphone");
		qp.add("3", "car");
		qp.add("4", "bike");
