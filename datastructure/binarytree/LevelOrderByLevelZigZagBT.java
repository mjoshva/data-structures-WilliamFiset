...
public class LevelOrderByLevelZigZagBT {
	...
	private void reverse(LinkedList<Integer> stack) {
	...
	public static void main(String[] args) {
		...
		LevelOrderByLevelZigZagBT bt = new LevelOrderByLevelZigZagBT();
		bt.helper();
